...
#include "soa/service/http_rest_endpoint.h"
#include "soa/service/rest_connection.h"
#include "soa/service/rest_request.h"
...
struct HttpRestConnection: public RestConnection {
    ...
    */
    ...
    {
        return !http->isZombie;  // NOTE: race condition
    }
