...
$(eval $(call test,http_client_test_v1,services test_services,boost manual)) # manual for spurious failures
$(eval $(call test,http_client_test_v2,services test_services,boost manual)) # manual for spurious failures
