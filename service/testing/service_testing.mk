...
$(eval $(call test,http_client_test_v3,services_asio test_services arch utils,boost))
...
$(eval $(call test,http_client_bench_v3,services_asio test_services arch utils boost_program_options,boost))
